...
<script>
  ...
  import wordmark from './../../assets/scrapbook-extras/ui-libraries-wordmark.png'
  import {
    pleaseWait
  } from 'please-wait'
      ...
      open() {
        if (!this.pleaseWaitInstance) {
          this.pleaseWaitInstance = pleaseWait({
            ...
            loadingHtml: '<div class="sk-chase sk-center"><div class="sk-chase-dot"></div><div class="sk-chase-dot"></div><div class="sk-chase-dot"></div><div class="sk-chase-dot"></div><div class="sk-chase-dot"></div><div class="sk-chase-dot"></div></div>'
