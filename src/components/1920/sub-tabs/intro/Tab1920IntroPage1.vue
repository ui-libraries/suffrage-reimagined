<template>
    <div class="intro-page-container">
        ...
        <div class="text-left">
            ...
            <div>
                <div>Flora Dunlap (1872-1952) served as the first president of the Iowa LWV, but she had been 
                ...
                <ul>
                    ...
                    <li><b>1912: </b>First woman elected to the Des Moines School Board, but refused to run again
                        in 1915 because her male colleagues had ignored her, making her an ineffective board member</li>
                    <li><b>1913-1916: </b>Served as president of the Iowa Equal Suffrage Association, 
                        participating in the 1913 automobile tour and spearheading the 1916 referendum campaign</li>
